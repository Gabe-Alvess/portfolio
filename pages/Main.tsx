import { AboutBtn, SkillBtn, ProjectBtn, ContactBtn, DownloadBtn, BackgroundCircles, Text } from "../components";
...
const Main = ({ pageInfo, pageInfoNL, pageInfoFR, pageInfoPT, scrollRef }: Props) => {
  ...
  return (
    <div className="h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative h-32 w-32 mx-auto">
        <Image className="rounded-full" fill src={urlFor(pageInfo?.introImage).url()} alt="" priority />
      </div>
      <div className="z-20">
