...
const Projects = ({ projects, pageInfo, pageInfoNL, pageInfoFR, pageInfoPT }: Props) => {
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <div className="flex items-center space-x-2 justify-center">
                {project?.technologies.map((technology) => (
                  <Image key={technology._id} src={urlFor(technology.image).url()} width={40} height={40} alt="" />
                ))}
              </div>
